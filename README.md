<!-- Animated Header -->
<h1 align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Orbitron&color=36BCF7&size=35&center=true&vCenter=true&width=850&lines=Hey+there!+I'm+Punith+H+Singh+👋;AI+%26+Cybersecurity+Developer+🧠;Full+Stack+Engineer+💻;Cloud-Native+Application+Builder+☁️;DevOps+and+Automation+Enthusiast+🚀">
</h1>
...
- 💡 Currently exploring: **AI-driven automation + microservice orchestration**
...
|----------|--------------|------------|------|
| 🔐 **Password Manager Web App** | Securely stores and manages passwords with analytics dashboard | React, MongoDB, Node.js | [🔗 View Repo](https://github.com/Punith-Singh/password-manager) |
| 🤖 **AI Chatbot Integration** | Flask-based Gemini chatbot with login/auth features | Flask, Oracle DB, Gemini API | [🔗 View Repo](https://github.com/Punith-Singh/AI-chatbot) |
| ☁️ **Cloud-Native App** | Microservice app with Docker, Kubernetes, Helm & Grafana | IBM Cloud, Terraform, Docker | [🔗 View Repo](https://github.com/Punith-Singh/cloud-native-app) |
| 💳 **Credit Card Application System** | Multi-step React form with validations & backend | React, Node.js, MongoDB | [🔗 View Repo](https://github.com/Punith-Singh/credit-card-app) |
...
<p align="center">
  ...
  <img src="https://github-profile-trophy.vercel.app/?username=Punith-Singh&theme=tokyonight&no-frame=true&margin-w=15" width="45%" />
</p>
...
- 🛰️ Favorite Stack: `React + Flask + Docker + AI`  
